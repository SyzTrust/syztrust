...
type Config struct {
	...
	BoardController string `json:"board_controller"`
	BoardServer     string `json:"board_server"`
	ProgsDir        string `json:"progs_dir"`
	PayloadDir      string `json:"payload_dir"`
	SigCovStateDir  string `json:"sigcovstate_dir"`
	TimerLog        string `json:"timer_log"`
	CommandPython   string `json:"command_python"`
	CorpusFile     string `json:"corpus_file"`
	TraceID        string `json:"trace_id"`
	StateFlag      string `json:"state_flag"`
	HandleDivision string `json:"handle_division"`
